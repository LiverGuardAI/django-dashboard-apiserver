...
class MedicalFacility(models.Model):
    ...
    name = models.CharField(max_length=200, verbose_name="기관명")
    type = models.CharField(max_length=50, choices=FACILITY_TYPE_CHOICES, verbose_name="기관 종류")
    ...
    rating = models.DecimalField(max_digits=2, decimal_places=1, null=True, blank=True, verbose_name="평점")
    created_at = models.DateTimeField(auto_now_add=True, verbose_name="생성일")
